...
public:
    ...
    bool stergeCarte(const std::string& issn);
    std::shared_ptr<Carte> gasesteCarte(const std::string& issn) const;
    ...
    std::string getIssnDupaIndex(size_t index) const;
    ...
    // Împrumuturi
    bool adaugaImprumut(const std::string& issn, const std::string& id_cititor,
                        const std::string& data_imp, const std::string& termen,
                        const std::string& obs);
    bool returneazaCarte(const std::string& issn, const std::string& id_cititor);
    const Imprumut* getImprumutDupaIndex(size_t index) const;

    // Returnare în 2 pași
    bool solicitaReturnare(const std::string& issn, const std::string& id_cititor);
