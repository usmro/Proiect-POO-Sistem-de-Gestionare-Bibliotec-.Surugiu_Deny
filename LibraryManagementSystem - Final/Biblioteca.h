...
public:
    ...
    const std::vector<InregistrareIstoric>& getToateIstoricLectura() const { return istoric_lectura; }
    const std::vector<Recenzie>& getToateRecenziile() const { return recenzii; }
    ...
    void afiseazaJurnalAudit(std::ostream& os, int linii = 50) const;
    std::vector<JurnalAuditRow> getJurnalAudit(int linii = 50) const;
